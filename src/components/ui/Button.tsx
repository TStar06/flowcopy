...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary:
      "text-background bg-background-ui border-background-ui hover:bg-background-ui/85 hover:border-background-ui/85 focus:ring-1 focus:ring-background-ui/50",
    "primary-soft":
